...
export const CampaignTile = ({ campaign, title }: { campaign: Result; title: String | undefined }) => {
  const { author, campaign: campaignAddress, commission, target, totalReward } = campaign;
  return (
    <Card direction={{ base: "column", sm: "row" }}>
      <Image objectFit="cover" maxW={{ base: "100%", sm: "200px" }} src="https://ipfs.io/ipfs/QmPbxeGcXhYQQNgsC6a36dDyYUcHgMLnGKnF8pVFmGsvqi" />
